...
class OMGIRLLightningAbstract(ABC, lightning.LightningModule):
    ...
    def rollout(self, x_0: OMGData) -> TrajectoryData:
        ...
        :return:
            Trajectory data containing states, sampled residual effects, old log probabilities, base model outputs,
    ...
    def _create_trajectory_data(self, states: list[OMGData],
        ...
        This method takes the states, sampled residual effects, old log probabilities, base model outputs, and any
        ...
        :param sampled_residual_effects:
            List of residual model effects at each timestep per field.
        :type sampled_residual_effects: list[dict[DataField, torch.Tensor]]
        :param old_log_probs:
            List of old log probabilities at each timestep per field.
